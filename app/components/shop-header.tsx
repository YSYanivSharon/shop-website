      ...
      <nav className='border-b shadow'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex justify-end'>
            ...
            {!email && <Link href='/shop/user/login' className='flex texflex font-semibold py-1 px-6 transition'>
              <UserIcon className='size-6' />
              Login
            </Link>}
            {email && <Menu>
              <MenuButton>{email}</MenuButton>
              <MenuItems anchor='bottom' className='border rounded-b-lg bg-white dark:bg-black'>
                <MenuItem>
                  <Link href='/shop/user/my-items' className='flex texflex font-semibold py-1 px-6 transition border'>
                    <ArchiveBoxIcon className='size-6' />
                    My Items
                  </Link>
                </MenuItem>
                <MenuItem>
                  <Link href='/shop/user/logout' className='flex texflex font-semibold py-1 px-6 transition border'>
